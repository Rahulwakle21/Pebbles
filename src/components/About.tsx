        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          <Reveal>
            ...
            <p className="mb-4 leading-relaxed text-zinc-600">
              ...
              construction, RERA law, and loan paperwork just to avoid
              getting burned. We started as advisors to friends and family
              navigating Pune West&apos;s fast-changing market — and grew
              into a dedicated channel partner because the demand for
              honest, informed guidance never stopped.
            </p>
